"""Settings panel for LastPass Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__lastpass_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=lastpass_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_lastpass"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("LastPass Settings & Accounts", level=2),
