"""HTTP client for LastPass Enterprise API."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://lastpass.com/enterpriseapi.php"

class LastPassEnterpriseClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-LastPassEnterprise-Connector/1.0.0"
        }
